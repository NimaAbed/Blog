        ...
        <Container maxWidth="lg">
            <Grid container>
                <Grid item xs={12} mt={9} display="flex" justifyContent="space-between">
                    <Typography color="primary" component="h2" variant="h4" fontWeight={700}>{data.post.title}</Typography>
                    <ArrowBackRoundedIcon onClick={() => navigate(-1)} fontWeight={500} />
                </Grid>
                <Grid item xs={12} mt={6}>
                    <img src={data.post.coverPhoto.url} alt={slug} style={{ width: "100%", borderRadius: "15px" }} />
                </Grid>
                <Grid item xs={12} mt={5} display="flex" alignItems="center">
                    ...
                    <Box component="div">
                        ...
                        <Typography component="p" variant="p" color="text.secondary" >{data.post.author.filed}</Typography>
                    </Box>
                </Grid>
